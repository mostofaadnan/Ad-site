<div class="modal fade" id="extendmodal" tabindex="-1" aria-labelledby="extendmodal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">New Extend</h5>
            ...
            <div class="modal-footer">
                <div class="btn-group" role="group" aria-label="Basic example">
                    ...
                    <button type="button" id="extendtypedatainsert" class="btn btn-primary" id="dataupdate">Save</button>
                </div>
            </div>
        </div>
    </div>
