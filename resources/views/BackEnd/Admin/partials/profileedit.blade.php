...
<div class="card user-profile">
    <div class="card-body image-body">
        <div class="main-img-preview">
            <img class="thumbnail img-preview" src="{{asset('storage/app/public/user/'.$user->image)}}" style="width:100px; height: 100px" name="image" class="img-thumbnail" title="Preview Logo">
        </div>
    </div>
